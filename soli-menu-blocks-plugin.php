...
add_action('init', function () {
  ...
  if (is_admin()) { // note the use of is_admin() to double check that this is happening in the admin
    ...
    $config = array(
      ...
      'raw_url' => 'https://raw.github.com/JoranOut/wp-soli-menu-blocks-plugin/master', // the GitHub raw url of your GitHub repo
      'github_url' => 'https://github.com/JoranOut/wp-soli-menu-blocks-plugin', // the GitHub url of your GitHub repo
      'zip_url' => 'https://github.com/JoranOut/wp-soli-menu-blocks-plugin/archive/wp-soli-menu-blocks-plugin.zip', // the zip url of the GitHub repo
